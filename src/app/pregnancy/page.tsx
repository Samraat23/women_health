...
export default function PregnancyPage() {
  return (
    <main className="min-h-screen bg-[var(--background)] text-[var(--secondary-text)]">
      <section className="relative left-1/2 w-screen -translate-x-1/2 overflow-hidden bg-[linear-gradient(135deg,var(--primary-color),var(--secondary-color))] px-5 py-8 text-white shadow-[0_28px_70px_rgba(27,20,99,0.20)] sm:px-8 md:px-12 lg:py-12">
